...
import styles from "./ims-hitech-erp.module.scss"; // Import SCSS file
...
export default function ImsHitechErp() {
  ...
  return (
    ...
    <div className={styles.pagecontainer}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.textcontainer}>
          <h1>Hitech Integrated Management Solution</h1>
          <p>
            HiTech Solution strives to give the customer a complete one-stop solution for Planning, 
            Budgeting, Forecasting And Modeling For Dynamic Management.
          </p>
        </div>
        ...
        <div className={styles.imagecontainer}>
          <img
            src="https://hitechnepal.com/images/erp-header-image-min.png" // Change this to your actual image path
            alt="IMS Hitech ERP"
            width={400}
            height={400}
          />
    ...
    {/* Second Section: "Why Hitech ERP" */}
    <div className={styles.whyHitechContainer}>
        <h2>Why Hitech ERP</h2>
        <div className={styles.whyImageContainer}>
          <img
            src="https://hitechnepal.com/images/erp-p.png"
      ...
      <div className={styles.learnMoreContent}>
       ...
       <div className={styles.industrySolutions}>
        ...
        <div className={styles.industryGrid}>
          {[
            { name: "Office", icon: "https://hitechnepal.com/images/product-icons/office.png" },
            { name: "Restaurant", icon: "https://hitechnepal.com/images/product-icons/restaurant.png" },
            { name: "Hospital", icon: "https://hitechnepal.com/images/product-icons/hospital.png" },
            { name: "School", icon: "https://hitechnepal.com/images/product-icons/school.png" },
            { name: "Factory", icon: "https://hitechnepal.com/images/product-icons/factory.png" },
            { name: "Farm", icon: "https://hitechnepal.com/images/product-icons/farm.png" },
            { name: "Logistics", icon: "https://hitechnepal.com/images/product-icons/logistics.png" },
            { name: "Retail", icon: "https://hitechnepal.com/images/product-icons/retail.png" },
            { name: "Trading", icon: "https://hitechnepal.com/images/product-icons/trading.png" },
            { name: "Books", icon: "https://hitechnepal.com/images/product-icons/books.png" },
            { name: "Construction", icon: "https://hitechnepal.com/images/product-icons/construction.png" },
            { name: "Hotel", icon: "https://hitechnepal.com/images/product-icons/hotel.png" },
          ].map((industry, index) => (
...
<div className={styles.ourReviews}>
 ...
 <div className={styles.howAppWorks}>
        ...
        <p>
          The screenshots below will give you an extensive peek into the working of the system and show you how easy and user-friendly it is to work in our software.
        </p>
          ...
          >
            {[
              ...
              <SwiperSlide key={index} className={styles.slide}>
                <img src={imageSrc} alt={`Slide ${index + 1}`} className={styles.slideImage} />
              </SwiperSlide>
            ))}
          </Swiper>

          {/* Attach buttons to refs */}
          <button ref={prevRef} className={styles.customPrev}>‹</button>
          <button ref={nextRef} className={styles.customNext}>›</button>
        </div>
      </div>
...
<div className={styles.textButtonSection}>
  <div className={styles.textContainer}>
    ...
    <p>Inquire now with your queries or request a demo and 
