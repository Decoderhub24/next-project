      ...
      <div className={styles.pagecontainer}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.textcontainer}>
            <h1>Swastik POS</h1>
            <p>
            Manage your Sales activities effortlessly with Swastik Point of Sales</p>
          </div>

          {/* Right Side - Image */}
          <div className={styles.imagecontainer}>
            <img
              src="https://hitechnepal.com/images/pos-monitor.png" // Change this to your actual image path
              alt="IMS Hitech ERP"
              width={400}
              height={400}
            />
