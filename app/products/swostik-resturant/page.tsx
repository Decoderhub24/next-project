      ...
      <div className={styles.pagecontainer}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.textcontainer}>
            <h1>Swastik Restaurant</h1>
            <p>
            Swastik Restaurant ERP is a touch enabled- desktop based restaurant management software designed to provide restaurants all the features and tools required for smooth order, billing, operation, accounting and management.</p>
          </div>

          {/* Right Side - Image */}
          <div className={styles.imagecontainer}>
            <img
              src="https://hitechnepal.com/images/swastik-restaurant-erp-banner.png" // Change this to your actual image path
              alt="IMS Hitech ERP"
              width={400}
              height={400}
            />
