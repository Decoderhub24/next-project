      ...
      <div className={styles.pagecontainer}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.textcontainer}>
            <h1>Pharmasoft</h1>
            <p>
            The Complete Pharmaceutical Accounting Software is a highly automated system for Invoicing, Inventory Control, and Accounting
            </p>
          </div>
          ...
          <div className={styles.imagecontainer}>
            <img
              src="https://hitechnepal.com/images/16.png" // Change this to your actual image path
              alt="IMS Hitech ERP"
              width={400}
              height={400}
            />
