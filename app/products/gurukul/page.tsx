      ...
      <div className={styles.pagecontainer}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.textcontainer}>
            <h1>Gurukul - HSMS</h1>
            <p>
            Hitech School Management Software is a complete Software for Schools and Colleges.</p>
          </div>

          {/* Right Side - Image */}
          <div className={styles.imagecontainer}>
            <img
              src="https://hitechnepal.com/images/classroom1.png" // Change this to your actual image path
              alt="IMS Hitech ERP"
              width={400}
              height={400}
            />
