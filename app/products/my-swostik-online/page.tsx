...
import swostikstyles from "./my-swostik-online.module.scss";
      ...
      <div className={styles.pagecontainer}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.textcontainer}>
            <h1>HiTech Cloud Accounting Software</h1>
            <p>
              It is a Web Based - highly automated system for Invoicing,
              Inventory Control and accounting with detailed business
          ...
          <div className={styles.imagecontainer}>
            <img
              src="https://hitechnepal.com/images/2.png" // Change this to your actual image path
              alt="IMS Hitech ERP"
              width={400}
              height={400}
            />
        ...
        <div className={swostikstyles.gridContainer}>
          {versions.map((version, index) => (
              ...
              <div key={index} className={swostikstyles.versionCard}>
                 <div className={swostikstyles.versionCardtext}>
                <h3>{version.title}</h3>
                </div>
                <button className={swostikstyles.arrowButton}>
                  <span>&rarr;</span>
                </button>
